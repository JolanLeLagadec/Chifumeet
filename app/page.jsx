    ...
    <main >
      ...
      <div className='p-8 h-full w-full border-t-2 border-cyan-500 '>
        <div className='flex flex-col justify-center items-center gap-14'>
          ...
          <p className=' text-3xl text-center w-[60%] leading-[3rem] dark:text-slate-400 text-slate-700'>Sur base de chifumi, rencontre et affronte des joueurs de ton secteur</p>
